...
class EmailViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    func sendEmail() {
        if MFMailComposeViewController.canSendMail() {
            ...
            mail.setMessageBody("<h2>Pet Information</h2></br>Name: \(pets?.name ?? "")</br></br>Gender: \(pets?.gender ?? "")</br></br>Pet Type: \(pets?.petType ?? "")</br></br>Breed: \(pets?.breed ?? "")</br></br>Color: \(pets?.color ?? "")</br></br>Birthday: \(pets?.birthday ?? "")</br></br><h2>Care Information</h2></br>Outside Schedule: \(pets?.outsideSchedule ?? "")</br></br>Primary Food: \(pets?.primaryFood ?? "")</br></br>Allergies: \(pets?.allergies ?? "")</br></br><h2>Medical Information</h2></br>Spayed/Neutered: \(pets?.spayedNeutered.description ?? "")</br></br>Microchip: \(pets?.microchip ?? "")</br></br>Vet Name & Contact: \(pets?.vetName ?? "")</br></br>Medications: \(pets?.medications ?? "")</br></br>Emergency Contact: \(pets?.emergencyContact ?? "")</br></br><h2>Additional Information</h2></br>Additional Info: \(additionalInfoTextView.text ?? "")", isHTML: true)
